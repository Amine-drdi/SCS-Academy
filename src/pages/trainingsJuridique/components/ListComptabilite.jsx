...
import { Comptabilite } from '../../../assets/data/comptabilite';
...
const FormationCard = ({ image, title, duration, instructors,id }) => {
  return (
    <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
      <NavLink to={`/formation/comptabilité/${id}`} className="block">
...
const ComptabiliteList = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {Comptabilite.map((formation) => (
          <FormationCard
            key={formation.id}
...
export default ComptabiliteList;