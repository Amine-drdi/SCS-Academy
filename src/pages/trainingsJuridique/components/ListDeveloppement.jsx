...
import { Developpement } from '../../../assets/data/developpement';
...
const FormationCard = ({ image, title, duration, instructors,id }) => {
  return (
    <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
      <NavLink to={`/formation/developpement/${id}`} className="block">
...
const DeveloppementList = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {Developpement.map((formation) => (
          <FormationCard
            key={formation.id}
            ...
            id={formation.id} // Pass _id to the component
...
export default DeveloppementList;