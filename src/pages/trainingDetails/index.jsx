...
import {trainings} from '../../assets/data/trainings'; // Assurez-vous d'importer correctement vos données
...
const TrainingDetails = () => {
  ...
  const formation = trainings.find((f) => f.id === parseInt(id)); // Conversion
