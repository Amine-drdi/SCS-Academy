    ...
    <section className="relative group flex flex-col h-[460px] bg-white overflow-hidden">
      <NavLink
       ...
       to={`/formations/btp/${id}`}
        ...
        className="w-full h-full p-5 absolute top-0 flex translate-y-full group-hover:translate-y-0 ease-in-out duration-1000 bg-gradient-to-r from-orange-500 to-orange-700 z-10 cursor-pointer"
      >
